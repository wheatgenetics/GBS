...
def count_blank_reads (blank_barcodes,seq_file,max_seqreads,records_to_skip, blank_read_report):
...
cmdline.add_argument('-o','--output',help='output file name')
...
for line_item in barcodefilelst:
    ...
    if seqfile == prevseqfile:
        ...
        count_blank_reads(blankbarcodes,prevseqfile,maxseqreads,recordstoskip,outputfile)
        blankbarcodes=set()
