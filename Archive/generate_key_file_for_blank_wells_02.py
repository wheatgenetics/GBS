...
# Version:  0.2 September 2,2014    Added command line parsing and csv keyfile output capability
...
else: message = ["Warning: No data found for ", sys.argv[1]]
...
try:
    ...
    print ('Unexpected error occured during report generation.')
